...
use crate::mm::{SIZE_LEVEL1, SVSM_SHARED_MAPPING_BASE, SVSM_SHARED_MAPPING_END};
...
impl GlobalRanges {
    ...
    fn init(&mut self) {
        let region_4k_start = SVSM_SHARED_MAPPING_BASE;
        let region_2m_start = SVSM_SHARED_MAPPING_BASE + SIZE_LEVEL1;
        let page_count_4k = (region_2m_start - SVSM_SHARED_MAPPING_BASE) / PAGE_SIZE;
        let page_count_2m = (SVSM_SHARED_MAPPING_END - region_2m_start) / PAGE_SIZE_2M;
